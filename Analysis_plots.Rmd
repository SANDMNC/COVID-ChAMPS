...
# Save plots preserving resolution
png("figures/DASSp2.png", width = 6.5, height = 3, res = 600, type = 'cairo', units='in') 
DASSp2
dev.off()
png("figures/DASSp3.png", width = 6.5, height = 3, res = 600, type = 'cairo', units='in') 
DASSp3
dev.off()
png("figures/DASSp4.png", width = 6.5, height = 3, res = 600, type = 'cairo', units='in') 
DASSp4
dev.off()
png("figures/DASSp6.png", width = 6.5, height = 3, res = 600, type = 'cairo', units='in') 
DASSp6
dev.off()
