...
corrmatrixpar <-  dplyr::select(covid_data, par_age, par_gender_num, par_ed_ord, income_famsize, DASSDep, DASSAnx, DASSStress)
#include both par and child vars
corrmatrixch <-  dplyr::select(covid_data_child, par_age, par_gender_num, par_ed_ord, income_famsize, DASSDep, DASSAnx, DASSStress,
                               ch_age, ch_gender_num, SDQemo, SDQcon, SDQhyp, SDQpeer, SDQpro, SDQemo2, SDQcon2, SDQhyp2, SDQpeer2, SDQpro2,PARQwarmth, PARQhostile, PARQwarmth, PARQhostile, PARQneglect, PARQundiff, PARQcontrol)


#colnames(corrmatrixpar) <- c("facts", "information", "child emotions", "parent emotions", "others' feelings", "reassurance", "didn't know what to say", "too upset")
